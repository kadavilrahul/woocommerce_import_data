...
console.log(`✓ Connected to WooCommerce API at ${process.env.SITE_URL}`);
...
const csvStream = fs.createWriteStream('data/product_data.csv');
...
async function fetchAllProductData() {
    try {
        ...
        console.log(`📁 Results saved to data/product_data.csv`);
